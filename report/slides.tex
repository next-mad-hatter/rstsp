...
\begin{itemize}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{../plot/build/pyr-2.eps}
    \caption{%
...
\begin{slide}[toc=]{Pyramidal Tours: Recurse!}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{../plot/build/pyr-3.eps}
...
\begin{slide}[toc=]{Strongly Balanced Tours: Dynamic Programming Solution}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.69\textwidth]{../plot/build/bal-1.eps}
      \caption{
...
{\small
  ...
  Open Tasks:
    \begin{itemize}
      \item implement BFS
      \item precompute flowers (uniqueness)
