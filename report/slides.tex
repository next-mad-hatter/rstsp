...
\begin{slide}[toc=]{Tour Quality: TSPLIB/VLSI Benchmarks}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.74\textwidth]{../plot/build/tsplib_med_val.eps}
    \caption{ILS over 29 TSPLIB/VLSI instances: tour quality.}
  \end{figure}
\end{slide}

\begin{slide}[toc=]{Measured Time: TSPLIB/VLSI Benchmarks}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.74\textwidth]{../plot/build/tsplib_med_time.eps}
    \caption{ILS over TSPLIB/VLSI instances: time needed.}
  \end{figure}
\end{slide}
