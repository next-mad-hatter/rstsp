...
\annotation{Bäh. TODO + abstract}
We have discussed general formal condiderations for application of dynamic
programming solutions to the traveling salesman problem,
which we then developed an implementation of.
