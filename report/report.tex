...
Usually yes yes yes Traveling Salesman Problem (also: TSP)
\index{TSP|see{Traveling Salesman Problem}}
\blockquote{%
  \index{Traveling Salesman Problem|(}
  A traveling merchant (or salesman) wishes to visit a given number of cities
  and return to the origin.
  Assuming that distance between the cities is known and does not change,
  what would be the shortes route?
  \index{Traveling Salesman Problem|)}
}
