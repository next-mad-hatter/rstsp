...
Pyramidal TSP, first described by (whom? \cite{bellman,gilmore}?), yields a
...
consider paths to be cost equivalent if they are equal under path reversal
as defined in \cref{def:pathop}.
...
\begin{define}
For $M \in \mathbb{R}$, we define $\operatorname{SBal}_n^M$ to be the set of all
...
\end{proposition}
\begin{proof}
  Analogous to \cref{prop:pyrall}, this follows directly from \cref{def:sbtour}.
\end{proof}
    ...
    \mbox{%
      \pgfplotstabletypeset[
        ...
        display columns/0/.style={%
          column name={\bfseries maximum node size},
          column type={g}
        },
        ...
        display columns/2/.style={%
          column name={\bfseries fixed point at depth},
          column type={g}
        },
...
as {\defstyle rotations} of the tour set.
