...
\begin{example}
  ...
  \begin{tabular}{gcgrg}
    ...
    \bottomrule
  \end{tabular}
  \caption{Sample path taken in the strongly balanced recursion tree along with optimal (for some fixed sample cost matrix) solution for each node.  Elements of $\mathcal{B}_m$ corresponding to the nodes are given as illustration.}
  \label{tbl:sbpath}
  \end{table}
\end{example}
