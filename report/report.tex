...
\documentclass[titlepage,twoside,index=totoc,bibliography=totoc]{scrartcl}
\KOMAoptions{fontsize=11pt}
\KOMAoptions{BCOR=1.3cm}
...
%\setmathfont[range={\mathcal,\mathbfcal},Scale=1.07,StylisticSet=1]{XITSMath}
%\setmathfont[Scale=1.07,StylisticSet=1]{XITSMath}
\setmathfont[StylisticSet=1]{XITSMath}
...
\begin{abstract}
  ...
  optimization; to this the traveling salesman problem and its special
  cases --- where dynamic programming can often be applied effectively ---
  are no exception.

  Herein we describe a general procedure for constructing, given a
...
\begin{example}
  ...
  \caption{Sample path taken in the strongly balanced recursion tree ($n = 7,M \geq 2$)
    ...
    Elements of $\mathcal{B}_m$ corresponding to the nodes are given for illustration purposes.}
  \label{tbl:sbpath}
  \end{table}
\end{example}
...
\label{tbl:nodeTypes}%
\end{table}
%\annotation{Difference increasing by one interesting?}
...
\centering
  ...
  \subfloat[strongly balanced, $M = 4,5,6$]{%
    \includegraphics[width=0.48\textwidth]{../plot/build/mlton_time_random_low.pdf}
    \label{fig:benchtime1}
  }\hfill\null
  \null\hfill%
  \subfloat[strongly balanced, $M = 2,3,4$]{%
    \includegraphics[width=0.48\textwidth]{../plot/build/mlton_time_random_fast.pdf}
    \label{fig:benchtime2}
  }\hfill\null\\
  \null\hfill%
  \subfloat[pyramidal and str.\ balanced with $M = 2,3$]{%
    \includegraphics[width=0.58\textwidth]{../plot/build/mlton_time_random_steady.pdf}
    \label{fig:benchtime3}
  }\hfill\null\\
  \null\hfill%
  \subfloat[pyramidal falls behind str.\ balanced ($M=3$)]{%
    \includegraphics[width=0.48\textwidth]{../plot/build/mlton_time_random_med.pdf}
    \label{fig:benchtime4}
  }\hfill\null
  \null\hfill%
  \subfloat[pyramidal falls behind str.\ balanced ($M=4$)]{%
    \includegraphics[width=0.48\textwidth]{../plot/build/mlton_time_random_hi.pdf}
...
\thisfloatpagestyle{empty}
  \centering
    ...
    \null\hfill%
    \subfloat[ILS over 28 TSPLIB instances: achieved tour quality]{%
      \includegraphics[width=0.59\textwidth]{../plot/build/tsplib_med_val.pdf}
    }\hfill\null\\
    \null\hfill%
    \makebox[\textwidth][c]{%
      \subfloat[TSPLIB instances: measured runtime]{%
        \includegraphics[width=0.59\textwidth]{../plot/build/tsplib_med_time.pdf}
      }\hfill\null
      \null\hfill%
      \subfloat[TSPLIB instances: convergence speed]{%
        \includegraphics[width=0.59\textwidth]{../plot/build/tsplib_med_conv.pdf}
      }\hfill\null
  }
