...
produced \cref{fig:pyratrace} as its execution trace, closely mirrors this exact
definition.
...
depth-first search and mentioned breadth-first search computation of
pyramidal TSP, we have not yet considered the bottom-up approach
widely used in imperative programming.
