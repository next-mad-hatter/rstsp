    ...
    \mbox{%
      \pgfplotstabletypeset[
        ...
        display columns/0/.style={%
          column name={\bfseries Problem size},
          column type={g}
        },
        ...
        display columns/2/.style={%
          column name={\bfseries Stable at},
          column type={g}
        },
...
\null\hfill%
\subfloat[fast]{%
  \includegraphics[width=0.64\textwidth]{../plot/out/time_mlton_random_low_fast.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[low]{%
  \includegraphics[width=0.64\textwidth]{../plot/out/time_mlton_random_low.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[hi]{%
  \includegraphics[width=0.64\textwidth]{../plot/out/time_mlton_random_hi.pdf}
}
\hfill\null
