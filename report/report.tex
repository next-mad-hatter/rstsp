...
We note that there is a natural
bijection between tours in $\mathcal{T}_n$ and cyclic permutations on
$\mathcal{N}_n$ (or, by same argument, paths of length $n-1$).

We will also sometimes need to view tours as somewhat different maps on
$\mathcal{N}$ or $\mathbb{R}^{n \times n}$.
\begin{define}
