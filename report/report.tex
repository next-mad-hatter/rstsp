...
\caption{%
  ...
  Results presented here have been produced on a test machine running
...
\caption{Benchmark results: 28 TSPLIB instances.}
\label{fig:benchTSPLIB}
\end{figure}

From what little testing this represents, we can reasonably conclude that
\begin{itemize}
  \item prior to the flower extension, none of the two neighbourhoods deliver
