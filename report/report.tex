...
\centering
  ...
  \null\hfill%
  \subfloat[graph]{%
    \includegraphics[width=0.64\textwidth]{../plot/out/num_types.pdf}
  }
  \hfill\null
...
\null\hfill%
\subfloat[low]{%
  \includegraphics[width=0.48\textwidth]{../plot/out/time_mlton_random_low.pdf}
}\hfill\null
\null\hfill%
\subfloat[fast]{%
  \includegraphics[width=0.48\textwidth]{../plot/out/time_mlton_random_fast.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[medium]{%
  \includegraphics[width=0.48\textwidth]{../plot/out/time_mlton_random_med.pdf}
}\hfill\null
\null\hfill%
\subfloat[hi]{%
  \includegraphics[width=0.48\textwidth]{../plot/out/time_mlton_random_hi.pdf}
}
\hfill\null
