...
\null\hfill%
\subfloat[low]{%
  \includegraphics[width=0.59\textwidth]{../plot/out/mlton_time_random_low.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[fast]{%
...
\null\hfill%
\subfloat[medium]{%
  \includegraphics[width=0.59\textwidth]{../plot/out/mlton_time_random_med.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[hi]{%
  \includegraphics[width=0.59\textwidth]{../plot/out/mlton_time_random_hi.pdf}
}
\hfill\null
...
\null\hfill%
\subfloat[random]{%
  \includegraphics[width=0.69\textwidth]{../plot/out/mlton_val_random_steady.pdf}
}\hfill\null
\caption{Results.}
\label{fig:timeGraph}
\end{figure}
