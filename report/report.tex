...
\begin{define}[(exponential) neighbourhood]
  A {\defstyle neighbourhood} ({\defstyle in}/{\defstyle over} $\mathcal{T}_n$) is a map
  \[
...
\begin{remark}
  If we now can solve the TSP efficiently over a fixed set of tours $T$ (for arbitrary matrices),
