...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.79\textwidth]{../plot/out/trace_pyr.pdf}
\caption{A trace of our implementation's pyramidal search graph traversal.}
\end{figure}

\subsubsection{Local search heuristic}
...
\[
  h_C \; : \;
    ...
    \left( C \right).
\]
Then $h_C\left(\left(1,2,\ldots,n\right)\right) = \operatorname{pyr}\left(C\right)$.
Since $\left(1,2,\ldots,n,1\right)$ is a pyramidal tour,
we have $\operatorname{len} \circ h_C \circ h_C \leq \operatorname{len} \circ h_C$.
In this way, iterating from $\left(1,2,\ldots,n\right)$ to a fixed point of $h_c$ yields a
...
\subsubsection{Brief design overview}
\subsubsection{Compiler, REPL, OS support}
...
\caption*{\captionsize \url{https://xkcd.com/399/}}
%\end{figure}
\end{wrapfigure}

\subsection{Lessons learned}
\subsubsection{Results compared}
\subsection{Areas for further research}
\subsubsection{Applicability and unexplored instance classes}
\subsubsection{Dynamic programming and concurrency}
