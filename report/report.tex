...
\begin{abstract}
  TODO\@.  Also, this is bachelor project.
...
strikes the right (for this project) balance between expresiveness and
...
\end{enumerate}
From what little testing this represents, we can reasonable summarize that
\begin{itemize}
  \item pyramidal ILS indeed represents a viable heuristic for the TSP;
  \item strongly balanced tours much less do so;
...
\null\hfill%
\subfloat[Tour cost comparison as observed on random instances.
...
We have identified consistent formal foundation to and then developed an
implementation of applying dynamic programming solutions to the traveling
salesman problem.

The latter, as we have successfully demonstrated herein, is general enough
to be easily extended to other neighbourhoods and efficient enough for
study of new such neighbourhoods or combinations\footnote{%
...
\begin{itemize}
  ...
  \item
    ...
    naïve paralellization does not seem to apply well to the
