...
to work\footnote{%
  The housekeeping environment -- i.e.\ build, testing,
  benchmarking and plotting scripts -- uses a wider set of tools
  all of which are usually available in any common {\ttfamily GNU/Linux}
  distribution today.
}
and can be used
\begin{itemize}
...
is comprehensively documented and available from \url{https://bitbucket.org/mad_hatter/rstsp/};
