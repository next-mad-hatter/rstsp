...
\subfloat[ILS over 28 TSPLIB instances: achieved tour quality]{%
  \includegraphics[width=0.61\textwidth]{../plot/build/tsplib_med_val.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[ILS over 28 TSPLIB instances: measured runtime]{%
  \includegraphics[width=0.61\textwidth]{../plot/build/tsplib_med_time.pdf}
}\hfill\null
