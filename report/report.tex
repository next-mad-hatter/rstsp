...
\begin{enumerate}[(i)]
  ...
  \item computed tour cost (as quotient to optimum,
    ...
    (sample size $29$, instance size under $130$, most of them euclidean).
\end{enumerate}
...
\null\hfill%
\subfloat[29 TSPLIB instances: observed tour quality]{%
  \includegraphics[width=0.67\textwidth]{../plot/build/tsplib_med_val.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[29 TSPLIB instances: runtime measured]{%
