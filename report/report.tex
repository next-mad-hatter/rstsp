...
in our tests, we have not been able to significantly improve\footnote{%
...
machine-generated) implementations of above heuristics to bring valuable
...
\null\hfill%
\subfloat[29 TSPLIB/VLSI instances: observed tour quality]{%
  \includegraphics[width=0.67\textwidth]{../plot/build/tsplib_med_val.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[29 TSPLIB/VLSI instances: runtime measured]{%
  \includegraphics[width=0.67\textwidth]{../plot/build/tsplib_med_time.pdf}
}\hfill\null
