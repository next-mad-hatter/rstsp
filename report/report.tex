...
\begin{enumerate}[(i)]
  ...
  \item computed tour cost (as quotient to optimum,
    ...
    (sample size $26$, instance size under $250$, most of them euclidean).
\end{enumerate}
...
\null\hfill%
\subfloat[26 TSPLIB/VLSI instances: observed tour quality]{%
  \includegraphics[width=0.67\textwidth]{../plot/build/tsplib_med_val.pdf}
}\hfill\null\\
\null\hfill%
\subfloat[26 TSPLIB/VLSI instances: runtime measured]{%
